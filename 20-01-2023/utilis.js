...
const putData = (obj, idProd) => {
  fetch(`https://api.escuelajs.co/api/v1/products/` + idProd, {
    ...
    .then((res) => res.json())
    .then((obj) => {
      createMsg("Elemento correttamente modificato");
      console.log(obj);
    })
    .catch((e) => {
      createMsg("Siamo spiacenti, si è verificato un errore");
...
const deleteData = (idProd) => {
  fetch(`https://api.escuelajs.co/api/v1/products/` + idProd, {
    ...
    .then((res) => res.json())
    .then((obj) => {
      createMsg("Elemento eliminato modificato");
      console.log(obj);
    })
    .catch((e) => {
      createMsg("Siamo spiacenti, si è verificato un errore");
...
export { qS, cE, postData, putData, deleteData };
